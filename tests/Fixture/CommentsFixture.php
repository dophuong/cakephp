...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'author' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => 'null', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'post_comments_key' => ['type' => 'index', 'columns' => ['post_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'comments_ibfk_1' => ['type' => 'foreign', 'columns' => ['post_id'], 'references' => ['posts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2017-04-20 09:03:12',
            'modified' => '2017-04-20 09:03:12',
            'post_id' => 1
        ],
    ];
}
